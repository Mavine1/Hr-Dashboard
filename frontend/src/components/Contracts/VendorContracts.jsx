...
const VendorContracts = () => {
    ...
    const getStatusIcon = (status) => {
        switch(status) {
            ...
            case 'expiring': return <ExclamationTriangleIcon className="w-4 h-4" />;
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-blue-600">Ksh {stats.totalValue.toLocaleString()}</p>
                        </div>
            ...
            <div className="space-y-4">
                {loading ? (
                    ...
                    filteredContracts.map((contract) => (
                        <div key={contract._id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div className="flex-1">
                                    ...
                                    <p className="text-gray-600 mt-1 line-clamp-2">{contract.description}</p>
                                    <div className="flex flex-wrap gap-4 mt-3 text-sm text-gray-500">
                                        <span>📄 {getContractTypeName(contract.contractType)}</span>
