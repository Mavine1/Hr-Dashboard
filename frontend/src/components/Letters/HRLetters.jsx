...
HR Department`
    ...
    const fetchLetters = async () => {
        try {
            ...
            setLetters([
                { _id: '1', referenceNumber: 'HR/LTR/2024/156', letterType: 'promotion', subject: 'Promotion to Senior Manager', employee: { name: 'John Doe' }, status: 'sent', createdAt: '2024-12-01' },
                { _id: '2', referenceNumber: 'HR/LTR/2024/157', letterType: 'appointment', subject: 'Appointment as Project Lead', employee: { name: 'Jane Smith' }, status: 'draft', createdAt: '2024-12-03' },
                { _id: '3', referenceNumber: 'HR/LTR/2024/158', letterType: 'warning', subject: 'Attendance Warning', employee: { name: 'Mike Johnson' }, status: 'pending', createdAt: '2024-12-04' },
            ]);
        } finally {
            setLoading(false);
        }
            ...
            <div className="space-y-4">
                {loading ? (
                    ...
                    filteredLetters.map((letter) => (
                        <div key={letter._id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow">
