...
const TaskCentre = () => {
    ...
    const fetchTasks = async () => {
        try {
            ...
            setTasks([
                { _id: '1', title: 'Update Employee Handbook', description: 'Review and update policies', assignedTo: { name: 'John Doe' }, priority: 'high', status: 'in-progress', dueDate: '2024-12-20', progress: 65 },
                { _id: '2', title: 'System Security Audit', description: 'Conduct security audit', assignedTo: { name: 'Jane Smith' }, priority: 'urgent', status: 'pending', dueDate: '2024-12-25', progress: 0 },
                { _id: '3', title: 'Budget Report Q4', description: 'Prepare Q4 report', assignedTo: { name: 'Mike Johnson' }, priority: 'medium', status: 'completed', dueDate: '2024-12-10', progress: 100 },
            ]);
        } finally {
            setLoading(false);
        }
    ...
    const fetchEmployees = async () => {
        try {
            ...
            setEmployees([
                { _id: '1', name: 'John Doe', department: 'IT' },
                { _id: '2', name: 'Jane Smith', department: 'HR' },
                { _id: '3', name: 'Mike Johnson', department: 'Sales' },
            ]);
        }
    };
            ...
            <div className="space-y-4">
                {loading ? (
                    ...
                    filteredTasks.map((task) => (
                        <div key={task._id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow">
